/*
	...
	Programa para obtener un criterio de estabilidad para hacer evolucionar la red con la funcion logisitica
...
int main(){
    ...
    double N,paso,pasos,T_max,T_0,T_min,hT;
	...
	double rand=0.0,E=0.0,T=T_0,p2;
